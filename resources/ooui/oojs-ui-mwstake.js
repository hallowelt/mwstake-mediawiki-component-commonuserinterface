 ...
 * @constructor
 */
OO.ui.MWStakeTheme = function OoUiWikimediaUITheme() {
	// Parent constructor
	OO.ui.MWStakeTheme.super.call( this );
};

/* Setup */

OO.inheritClass( OO.ui.MWStakeTheme, OO.ui.Theme );
 ...
 * @inheritdoc
 */
OO.ui.MWStakeTheme.prototype.getElementClasses = function ( element ) {
	// Parent method
	var variant, isFramed, isActive, isToolOrGroup,
		...
		// Parent method
		classes = OO.ui.MWStakeTheme.super.prototype.getElementClasses.call( this, element );
 ...
 * @inheritdoc
 */
OO.ui.MWStakeTheme.prototype.getDialogTransitionDuration = function () {
	return 250;
};

/* Instantiation */

OO.ui.theme = new OO.ui.MWStakeTheme();

}( OO ) );

//# sourceMappingURL=oojs-ui-mwstake.js.map.json